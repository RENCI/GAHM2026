...
storm_name        = 'CARLA';
storm_year        = 1961;
track_file        = 'ibtracs_Carla_R34_Shohei_short.csv';
track_type        = "IBTrACS";
storm_designation = 'AL03';
debug             = true;
GAHM2026_start    = datetime(1961,09,07,00,0,0);  % >= first time in track_file
GAHM2026_end      = datetime(1961,09,12,12,0,0);  % <= last time in track file
...
% sepenvhur.background_file   = 'https://tdsres.apps.renci.org/thredds/dodsC/Datalayers/ERA5/global.1/uvp/<year>/<year>.nc';
   sepenvhur.background_file    = 'https://tdsres.apps.renci.org/thredds/dodsC/Datalayers/ERA5/global.1/uvp/1961/09.nc';
...
if output_info.type == "grid"
    ...
    output_info.nlon   = 401;
    output_info.nlat   = 401;
