...
debug             = true;
storm_start       = datetime(1961,9,7,0,0,0);
storm_end         = datetime(1961,9,12,12,0,0);
...
output_info.pres_units     = "Pa";  % pressure units in NetCDF output: "mb" or "Pa"
