...
WAF_info.flag      = true;                       % set = false if not using
WAF_info.file_name = fullfile('input/WAF_30deg_10km_6km_15deginc_79points_Florence');
...
output_info.type           = "points";  % either "grid" or "points"
