...
storm_name        = 'MICHAEL';      % IBTrACS uses all caps for names
storm_year        = 2018;
track_file        = 'ibtracs.NA.list.v04r01.csv';
storm_designation = 'AL14';
debug             = false;
storm_start       = datetime(2018,10,7,0,0,0);
storm_end         = datetime(2018,10,15,18,0,0);

%% ===== SeparateEnvHur parameters =====
sepenvhur.background_file    = 'https://tdsres.apps.renci.org/thredds/dodsC/Datalayers/ERA5/regional/na/uvp/<year>/<year>.nc';
