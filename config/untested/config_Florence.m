...
storm_end         = datetime(2018,9,17,12,0,0);

%% ===== SeparateEnvHur parameters =====
sepenvhur.background_file    = 'https://tdsres.apps.renci.org/thredds/dodsC/Datalayers/ERA5/regional/wna/uvp/2018/201809.wna.nc';
