function ATCF2 = readATCFfort22(input_file,input_file_type)
% readATCFfort22  Read and parse ATCF/fort.22 format TC track files.
%
    ...
    runtype = rtype(1);
    ATCF.runtype = rtype;
    if runtype == "OFCL" || runtype == "BEST" || ...
        runtype == "IBTr" || runtype == "fort22" || ...
        runtype == "MAPP"
    else
