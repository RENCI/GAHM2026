classdef GAHM2026DiagPlotter < handle
% GAHM2026DiagPlotter  Unified plotting and diagnostics class for GAHM2026.
%
%   Accepts output from run_GAHM2026 (Result struct) or from the
%   SeparateEnvHur pipeline (.mat file or pre-loaded struct).
%
% CONSTRUCTORS
%   obj = GAHM2026DiagPlotter(Result)
%   obj = GAHM2026DiagPlotter(Result, opts)
%   obj = GAHM2026DiagPlotter.fromSepEnvHur(sepfile_or_struct)
...
%                Brian Blanton / UNC/RENCI
    ...
    methods
        ...
        function obj = GAHM2026DiagPlotter(Result, opts, source)
        % Constructor.
        %   GAHM2026DiagPlotter(Result)
        %   GAHM2026DiagPlotter(Result, opts)
        %   GAHM2026DiagPlotter(Result, opts, source)  — internal use by fromSepEnvHur
