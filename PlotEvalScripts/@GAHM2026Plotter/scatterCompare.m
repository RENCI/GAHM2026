function fig = scatterCompare(obj, X, Y, nplot, titleStr, xlabelStr, ylabelStr, legendLabels)
% scatterCompare  1:1 scatter comparison plot.
%
%   fig = obj.scatterCompare(X, Y, nplot, titleStr, xlabelStr, ylabelStr)
%   fig = obj.scatterCompare(X, Y, nplot, titleStr, xlabelStr, ylabelStr, legendLabels)
%
